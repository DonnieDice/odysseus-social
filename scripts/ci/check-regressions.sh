...
fixed_targets="$(
  grep -E "name: (Python wheel and sdist|Git source archive|Docker image|AUR source package|macOS standalone|Windows standalone)" .github/workflows/package.yml | wc -l | tr -d ' '
)"
